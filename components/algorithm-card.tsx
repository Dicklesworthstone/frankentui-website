...
export default function AlgorithmCard({ algorithm }: { algorithm: Algorithm }) {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <FrankenContainer withStitches={false} className="group h-full glass-modern transition-all duration-500 hover:bg-green-500/[0.02] border-white/5 hover:border-green-500/20">
